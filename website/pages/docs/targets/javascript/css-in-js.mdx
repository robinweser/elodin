...
var felaAdapter = require('@elodin/generator-css-in-js/adapter/fela').default
...
> **Missing your favourite library?** File an issue and we'll try to add an adapter for it!
...
```javascript
var createGenerator = require('@elodin/generator-css-in-js').createGenerator
var reactFelaAdapter = require('@elodin/generator-css-in-js/adapter/react-fela')
  .default

const config = {
  devMode: true,
  adapter: reactFelaAdapter,
  rootNode: '#__next',
}
