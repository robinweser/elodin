...
Views are the main building blocks of Elodin. They contains style declarations for a single view component which in general is a reuseable, user interface component.
...
Text is another main building blocks of Elodin. They are very similar to Views except that they're exclusively for text components. It supports all kind of text specific properties.
